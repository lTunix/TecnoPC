...
<head>
 ...
 <title>TecnoPC | Modificar Usuario</title>
...
<body >
 ...
 <div id="principal">
    ...
    <form action="../ModificarUsuario.do" name="formulario_registro" method="get">
        Rut: <input type="text" id="rut" name="rut" value="<%= aux.getRut() %>"> <br>
        Nombre Usuario: <input type="text" id="nombreUsu" name="nombreUsu" value="<%= aux.getNomusu() %>"> <br>
        Nombre: <input type="text" id="nombre" name="nombre" value="<%= aux.getNombre() %>"> <br>
        Apellido: <input type="text" id="apellido" name="apellido" value="<%= aux.getApellido() %>"> <br>
        Correo: <input type="text" id="correo" name="correo" value="<%= aux.getEmail() %>"> <br>        
        Telefono: <input type="text" id="telefono" name="telefono" value="<%= aux.getTelefono() %>"> <br>        
        Contraseña: <input type="password" id="clave" name="clave" value="<%= aux.getClave() %>"> <br> <br/>
        Sexo:
    ...
    <option name="año" value="1905">1905</option>
                            ...
                            <br/>
                            País: <input type="text" id="pais" name="pais" value="<%= aux.getPais() %>"> <br>
        </select>   <br/>
        Ciudad: <input type="text" id="ciudad" name="ciudad" value="<%= aux.getCiudad() %>"> <br>
        Comuna: <input type="text" id="comuna" name="comuna" value="<%= aux.getComuna() %>"> <br>
        Rol:    <select name="rol">
