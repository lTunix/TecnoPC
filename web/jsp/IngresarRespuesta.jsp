...
<head>
 ...
 <title>TecnoPC | Crear Respuesta</title>
...
<body >
 ...
 <div id="principal">
    ...
    <form action="../AgregarRespuestaTema.do" name="formulario_registro" method="get">
        Respuesta: <textarea cols="50" rows="10" name="respuesta"></textarea> <br>
        Id Tema: <input readonly="readonly" type="text" id="titulo" name="idtema" value="<%= request.getParameter("idTema") %>"> <br>
